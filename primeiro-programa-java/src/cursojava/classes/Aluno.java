...
public class Aluno extends Pessoa {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((dataMaricula == null) ? 0 : dataMaricula.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (dataMaricula == null) {
			if (other.dataMaricula != null)
				return false;
		} else if (!dataMaricula.equals(other.dataMaricula))
			return false;
	...
	public String msgMaiorIdade() {
		return this.pessoaMaiorIdade() ? "Oba aluno é maior de idade ": "Ixi vc é menor de idade";
	}
